...
@section('content')
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="row mb-2">
                <div class="col-sm-3">
                    <a href="{{route('admin.project.edit',['id'=>$data->id])}}"
                       class="btn btn-gradient-info btn-rounded btn-fw" style="width:100px">edit</a>

                </div>


                <div class="col-sm-3">
                    <a href="{{route('admin.project.destroy',['id'=>$data->id])}}"
